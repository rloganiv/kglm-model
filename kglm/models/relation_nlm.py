...
@Model.register('relation-nlm')
class RelationLm(Model):
    def __init__(self,
                 vocab: Vocabulary,
    ...
    def forward(self,  # pylint: disable=arguments-differ
        ...
        batch_size, entity_dim = shortlist['entity_ids'].size()
        relation_dim = self._relation_embedder.get_output_dim()
        dynamic_relations = reset.new_zeros((batch_size,
                                             entity_dim,
                                             entity_dim,
                                             relation_dim),
                                             dtype=torch.float32)
    ...
    def _forward_loop(self,
                      ...
                      dynamic_relations: torch.Tensor,
